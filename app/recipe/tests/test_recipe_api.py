...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test creating a recipe with existing tag success."""
    ...
    def test_create_tag_on_update(self):
        """Test creating a tag when updatin g a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_ingredient_exist(self):
    ...
    def test_create_ingredient_on_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        ingredient = Ingredient.objects.get(user=self.user, name='lime')
        self.assertIn(ingredient, recipe.ingredients.all())

    def test_update_recipe_assign_ingredient(self):
        """Test assigning an ixisting ingredient when updating a recipe."""
